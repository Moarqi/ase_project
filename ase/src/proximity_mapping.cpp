...
void
setDistance(geometry_msgs::Twist* twist, MappingState _nextState = MappingState::ALIGN_BOUNDARY)
{
...
void
alignWithBoundary(geometry_msgs::Twist* twist,
                  MappingState _nextState = MappingState::TRACE_BOUNDARY,
                  bool _align = true)
{
